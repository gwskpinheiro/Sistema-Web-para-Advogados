...
<div class="container">
    ...
    <form action="{{ route('clientes.update', $cliente) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="cpf_cnpj" class="form-control @error('cpf_cnpj') is-invalid @enderror" value="{{ old('cpf_cnpj', $cliente->cpf_cnpj) }}">
        ...
        <div class="mb-3">
            ...
            <textarea name="endereco" class="form-control @error('endereco') is-invalid @enderror">{{ old('endereco', $cliente->endereco) }}</textarea>
